...
MOUTH_AR_THRESH = 0.6
MOUTH_AR_THRESH1 = 0.4
MOUTH_AR_THRESH2 = 0.2
LAR_THRESH = 0.25
MOUTH_AR_CONSECUTIVE_FRAMES = 15
EYE_AR_THRESH = 0.22
EYE_AR_THRESH2 = 0.16
EYE_AR_CONSECUTIVE_FRAMES = 15
LMAR_CONSECUTIVE_FRAMES = 15
RMAR_CONSECUTIVE_FRAMES = 15
...
while True:
    ...
    if diff_ear > WINK_AR_DIFF_THRESH:
        ...
        elif ear <= EYE_AR_THRESH and ear >= EYE_AR_THRESH2:
            EYE_COUNTER += 1
    ...
    elif mar <= MOUTH_AR_THRESH and mar >= MOUTH_AR_THRESH1:
        MOUTH_COUNTER += 1
    ...
    elif mar <= MOUTH_AR_THRESH1 and mar >= MOUTH_AR_THRESH2:
        MOUTH_COUNTER += 1
